...
from image_stylization import image_utils, learning

flags = tf.app.flags
flags.DEFINE_string("style_files", None, "Style image files.")
flags.DEFINE_string("output_file", None, "Where to save the dataset.")
flags.DEFINE_bool(
    "compute_gram_matrices", True, "Whether to compute Gram" "matrices or not."
)
FLAGS = flags.FLAGS
...
def main(unused_argv):
    ...
    tf.logging.info(
        "Output TFRecord file is saved at %s" % os.path.expanduser(FLAGS.output_file)
    )
